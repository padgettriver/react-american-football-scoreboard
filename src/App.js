  ...
  <div className="home__score">{homeScore}</div>
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button className="homeButtons__fieldGoal" onClick={() => homeSetScore(homeScore + 4)}>Home Field Goal</button>
        </div>
        <div className="awayButtons">
          <button className="awayButtons__touchdown" onClick={() => awaySetScore(awayScore + 7) }>Away Touchdown</button>
          <button className="awayButtons__fieldGoal" onClick={() => awaySetScore(awayScore + 4)}>Away Field Goal</button>
        </div>
      </section>
    </div>
  );
